...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="left" valign="middle" nowrap="nowrap"><table width="240" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="240" height="15" colspan="2" align="left" valign="middle">欢迎您：<?php echo $_SESSION["username"]; ?></td>
        </tr>
      <tr valign="top">
        <td width="120" height="15" align="center">&nbsp;</td>
        <td width="120" align="center"><a href="logout.php">会员注销</a></td>
        </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="137" height="30" align="center" valign="middle" nowrap="nowrap" bgcolor="#993399"><ul id="MenuBar1" class="MenuBarHorizontal">
        ...
        <li><a href="#" class="MenuBarItemSubmenu">会员之家</a>
          <ul>
            <li><a href="meminfo.php">会员信息</a></li>
            <li><a href="evaluate.php">体质测评</a></li>
            <li><a href="#">健身计划</a></li>
            <li><a href="sportdata.php">运动数据</a></li>
          </ul>
        </li>
