...
require_once ('dbconf.php');
 session_start();
  ...
  $ydata = array($row[2],$row[3],$row[4],$row[5],$row[6],$row[7],$row[8],$row[9],$row[10],$row[11],$row[12],$row[13],$row[14],$row[15],$row[16],$row[17],$row[18],$row[19],$row[20],$row[21],$row[22],$row[23],$row[24],$row[25]);
	}
   ...
   $sql="UPDATE sportdata SET dtotalstep='$sum' WHERE username='$uname'";                   //更新sportdata表中的一个列
...
$graph->title->Set('Today Sport Curve Graph');
